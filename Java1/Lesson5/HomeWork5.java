...
class HomeWork5 {
    ...
    public static void main(String[] args) {
        ...
        Employe[] employeArr = { //Разбор ДЗ
        new Employe("Ivanov Ivan Ivanvich", "Engineer", "ivivan@mailbox.com", "89231238512", 30000, -40),
        new Employe("Sidorov Sidor Sidorovich", "Worker", "sid@mailbox.com", "89562548542", 50000, 0),
        new Employe("Moskova Moska Moskovna", "Apostol", "moska@mailbox.com", "86666666666", 10000, 500),
        new Employe("Kusakov Kusaka Kusakovich", "Prosto Bog", "Kusaka@mailbox.com", "81313131313", 100500, 100500),
        new Employe("Kotov Kot Kotovich", "Meauker", "kot@mailbox.com", "89158464257", 50000, 41)
        };
        ...
        for /*(int i = 0; i < employeArr.length; i++)*/
            (Employe employe : employeArr) { //Разбор ДЗ
